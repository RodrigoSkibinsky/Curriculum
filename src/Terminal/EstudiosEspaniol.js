...
function EstudiosEspaniol({ name, textColor }) {
    return(
        <div className='plain-text'>
            ...
            <p className='terminal-text oculto'><b style={{color: textColor,}}>{name}</b>Escolaridad disponible <a href='/Escolaridad1.pdf' target='_blank'>aquí</a></p>
...
export default EstudiosEspaniol