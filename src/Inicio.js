...
function Inicio({ name, textColor }) {
    return(
        <div className='plain-text'>
            ...
            <p className='terminal-sub-title'><b style={{color: textColor}}>{name}</b></p>
            <p style={{color:'red'}}>Advertencia: por el momento esta pagina no esta optimizada para dispositivos móviles o touch-screen.</p>
        </div>
    );
}
